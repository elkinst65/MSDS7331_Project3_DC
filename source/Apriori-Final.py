'''
Association Rules Mining, Apriori Implementation

https://github.com/timothyasp/apriori-python

Original code from Timothy Asp and Caleb Carlton
'''
...
def main(arguments):
    ...
    if  num_args < 3 or num_args > 4:
        ...
        goodsData = csv.reader(open('data/DC_Crime_Goods_3.csv', "r"))
...
if __name__ == '__main__':
    arguments = ["data/DC_Crime_Transaction_Final.csv", .03, .7]
    main(arguments)